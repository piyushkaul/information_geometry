                   ...
                   do
                         ...
                         do
                               ...
                               do
                                     ...
                                     python main.py --model cnn --gamma $gamma --lr $lr --optimizer $opt --subspace-fraction $subspace_fraction --inv-period $inv_period --proj-period $proj_period --inv-type $inv_type --dataset fashion_mnist --epochs 100
                              done
                         done
                    done
             done          
