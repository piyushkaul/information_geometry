...
for i in {1..30};
do
python main.py --model mlp --gamma 0.8 --lr 0.001 --optimizer adam_ngd --subspace-fraction 0.95 --inv-period 50 --proj-period 50 --inv-type recursive --dataset fashion_mnist --epochs 100 -$i
done
for i in {1..30};
do
python main.py --model mlp --gamma 0.8 --lr 0.001 --optimizer sgd --dataset fashion_mnist --epochs 100 $i
done
for i in {1..30}; 
do
python main.py --model mlp --gamma 0.8 --lr 0.001 --optimizer adam_ngd --subspace-fraction 0.95 --inv-period 50 --proj-period 50 --inv-type recursive --dataset fashion_mnist --epochs 100 --random-projection $i
done
